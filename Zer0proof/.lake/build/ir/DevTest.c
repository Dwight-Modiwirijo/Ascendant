...
{
lean_object* x_1; 
x_1 = lean_mk_string_unchecked("✅ Test start", 14, 12);
return x_1;
}
}
...
{
lean_object* x_1; 
x_1 = lean_mk_string_unchecked("De waarde van x is: ", 20, 20);
return x_1;
}
}
...
lean_inc(x_4);
lean_dec(x_3);
x_5 = l_main___closed__6;
x_6 = l_IO_println___at_main___spec__1(x_5, x_4);
return x_6;
}
else
{
...
LEAN_EXPORT lean_object* initialize_DevTest(uint8_t builtin, lean_object* w) {
lean_object * res;
...
res = initialize_DevTest(1 /* builtin */, lean_io_mk_world());
