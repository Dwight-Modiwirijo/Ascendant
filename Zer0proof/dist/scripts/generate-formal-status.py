...
TI_EXPECTED_DECLARATIONS = (
    ...
    "AscendantRoute.Release.TI.Contract.IsTerminus",
    "AscendantRoute.Release.TI.Contract.descends",
    "AscendantRoute.Release.TI.Contract.terminus_iff_zero",
    "AscendantRoute.Release.TI.Contract.terminus_unique",
    "AscendantRoute.Release.TI.Contract.terminus_fixed",
    ...
    "AscendantRoute.Release.TI.natContract_terminus_characterization",
    "AscendantRoute.Release.TI.natContract_terminus_fixed",
    "AscendantRoute.Release.TI.natContract_existsUniqueTerminus",
)
